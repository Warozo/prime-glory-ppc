...
(function () {
  ...
  const RAW = [
    { code: 'RM001', name: 'Rose Hydrosol Base', nameTh: 'เบสน้ำกุหลาบ',     unit: 'kg', cat: 'Raw material', status: 'A' },
    { code: 'RM002', name: 'Hyaluronic Acid',    nameTh: 'ไฮยาลูรอนิค',      unit: 'kg', cat: 'Raw material', status: 'A' },
    { code: 'RM003', name: 'Rose Fragrance Oil', nameTh: 'น้ำมันหอมกุหลาบ',  unit: 'kg', cat: 'Raw material', status: 'A' },
    { code: 'RM004', name: 'Vitamin C (SAP)',    nameTh: 'วิตามินซี',        unit: 'kg', cat: 'Raw material', status: 'A' },
    { code: 'RM005', name: 'Niacinamide',        nameTh: 'ไนอาซินาไมด์',     unit: 'kg', cat: 'Raw material', status: 'A' },
    { code: 'RM006', name: 'Glycerin USP',       nameTh: 'กลีเซอรีน',        unit: 'kg', cat: 'Raw material', status: 'A' },
    { code: 'RM007', name: 'Titanium Dioxide',   nameTh: 'ไทเทเนียมไดออกไซด์', unit: 'kg', cat: 'Raw material', status: 'A' },
    { code: 'RM008', name: 'Iron Oxide Pigment', nameTh: 'ไอรอนออกไซด์',     unit: 'kg', cat: 'Raw material', status: 'A' },
    { code: 'RM009', name: 'Carnauba Wax',       nameTh: 'ไขคาร์นัวบา',      unit: 'kg', cat: 'Raw material', status: 'A' },
  ...
  function buildState() {
    return JSON.parse(JSON.stringify({
      raw: RAW, fg: FG, boms: BOMS, customers: CUSTOMERS, suppliers: SUPPLIERS, salesReps: SALESREPS, defects: [], qaDefects: [],
