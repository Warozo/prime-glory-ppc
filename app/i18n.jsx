...
(function () {
  const DICT = {
    ...
    'nav.partners':    { th: 'ทะเบียนคู่ค้า/พนักงาน/QA', en: 'Partners / Staff / QA' },
    ...
    'db.dailyoutput':   { th: 'ผลผลิตรายวัน', en: 'Daily Output' },
    'db.totalrow':      { th: 'รวมทุกสาย', en: 'All lines' },
    ...
    'sf.pickday':    { th: 'เลือกวัน', en: 'Pick day' },
